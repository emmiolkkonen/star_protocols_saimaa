...
#From https://github.com/stschiff/msmc-tools
...
with open("data/reference/snpable/mask_35_50.fa", "r") as f:
  for line in f:
    if line.startswith('>'):
      chr = line.split()[0][1:]
      mask = MaskGenerator("data/reference/snpable/posmask/norppa_12122017_ctg{}.mask.bed.gz".format(chr), chr)
      pos = 0
      continue
    for c in line.strip():
      pos += 1
